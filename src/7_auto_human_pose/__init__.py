...
fileStartDir='/usr/share/makehuman/plugins/7_auto_human_pose'
fileResult = fileStartDir + '/data/MyAutoData/'
filepath1 = fileStartDir + '/data/MyAutoData/ORIGINAL_MODEL.bvh'
fileout = fileStartDir + '/data/MyAutoData/OUTPUT_MODEL.bvh'
filepicbvh = fileStartDir + '/data/MyAutoData/MyPicture.bvh'
