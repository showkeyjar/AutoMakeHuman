...
fileResult=os.path.abspath(os.path.join(os.path.dirname('7_auto_human_pose.py'),os.path.pardir))+'/makehuman/data/MyAutoData/'
filepath1=os.path.abspath(os.path.join(os.path.dirname('7_auto_human_pose.py'),os.path.pardir))+'/makehuman/data/MyAutoData/ORIGINAL_MODEL.bvh'
fileout=os.path.abspath(os.path.join(os.path.dirname('7_auto_human_pose.py'),os.path.pardir))+'/makehuman/data/MyAutoData/OUTPUT_MODEL.bvh'
filepicbvh=os.path.abspath(os.path.join(os.path.dirname('7_auto_human_pose.py'),os.path.pardir))+'/makehuman/data/MyAutoData/MyPicture.bvh'
filepicture=os.path.abspath(os.path.join(os.path.dirname('7_auto_human_pose.py'),os.path.pardir))+'/makehuman/data/MyAutoData/picture.png'
